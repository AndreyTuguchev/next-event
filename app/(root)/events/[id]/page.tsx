                ...
                <div className="flex w-full flex-col gap-8 p-5 md:p-10">
                    ...
                    <div className="flex flex-col gap-5">
                        <div className="flex gap-2 md:gap-3 items-center">
                            <Image src={`${process.env.NEXT_PUBLIC_CDN_URL}/assets/icons/calendar.svg`} width={32} height={32} alt="calendar" className="filter-grey"  />
                            <p>{eventStartData.dateOnly} - {eventStartData.timeOnly} / {eventEndData.dateOnly} - {eventEndData.timeOnly} </p>
                        </div>
                    </div>

                    <div className="p-regular-20 flex items-center gap-3">
                        <Image width={32} height={32} src={`${process.env.NEXT_PUBLIC_CDN_URL}/assets/icons/location.svg`} alt="location" />
