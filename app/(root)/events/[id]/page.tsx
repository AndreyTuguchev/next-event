...
export default async function EventPage({
  ...
  return (
    <>
      <section className='flex justify-center bg-primary-50 bg-contain !pt-[85px]'>
            ...
            <div className='flex flex-col gap-6'>
              ...
              <div className='flex flex-col gap-3 sm:flex-row sm:items-center'>
                <div className='flex gap-3'>
                  ...
                  <p className='p-medium-16 break-words rounded-full bg-grey-500/10 px-4 py-2.5 text-gray-500'>
                    {event.category.name}
                  </p>
                </div>
