...
export default async function EventPage({
  ...
  return (
    <>
      <section className="flex justify-center !pt-[85px] bg-primary-50 bg-contain">
          ...
          <div className="flex w-full flex-col gap-8 p-5 md:p-10">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div className="flex gap-3">
                  ...
                  <p className="break-words p-medium-16 rounded-full bg-grey-500/10 px-4 py-2.5 text-gray-500">
                    {event.category.name}
                  </p>
                </div>
            ...
            <div className="flex flex-col gap-5">
              <div className="flex gap-2 md:gap-3 items-center">
                ...
                />
                <p>
                  {eventStartData.dateOnly} - {eventStartData.timeOnly} /{" "}
                  {eventEndData.dateOnly} - {eventEndData.timeOnly}{" "}
                </p>
              </div>
            </div>
            ...
            <p className="break-words p-medium-16 lg:p-regular-18">
              {event.description}
            </p>
            {event.url && (
              <a
