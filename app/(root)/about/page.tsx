...
export default function AboutPage(){
    ...
    return (
        ...
        <section className="h-[35vh] md:h-[50vh] relative bg-cover bg-center flex items-center " >
            <div className="absolute w-full h-full blur-[1px] md:blur-[3px] bg-no-repeat bg-center bg-cover lazyloaded" style={{ backgroundImage: `url(/assets/images/about/about-page-hero.jpg)` }} ></div>
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center ">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center">
                    <Image priority src={`/assets/images/about/homepage-hero.jpg`} width={1038} height={661} alt='about section image'  className="h-auto w-auto max-h-full" unoptimized />
                </div>
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center md:order-2">
                    <Image src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2026%2026%22%3E%3C/svg%3E" data-src={`/assets/images/about/homepage-events-section-v2.jpg`} width={793} height={562} alt='about section image'  className="h-auto w-auto max-h-full" />
                </div>
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center ">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center">
                    <Image src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2026%2026%22%3E%3C/svg%3E" data-src={`/assets/images/about/homepage-searching.jpg`} width={950} height={950} alt='about section image' className="h-auto w-auto max-h-full"  />
                </div>
                <div className="about-section-item md:h-full w-full md:p-10 flex flex-col items-center md:items-start justify-center text-center md:text-left">
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center md:order-2">
                    <Image src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2026%2026%22%3E%3C/svg%3E" data-src={`/assets/images/about/homepage-pagination-v2.jpg`} width={650} height={650} alt='about section image'  className="h-auto w-auto max-h-full"  />
                </div>
                <div className="about-section-item md:h-full w-full md:p-10 flex flex-col items-center md:items-end justify-center text-center md:text-left ">
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center ">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center">
                    <Image src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2026%2026%22%3E%3C/svg%3E" data-src={`/assets/images/about/event-page-hero.jpg`} width={950} height={950} alt='about section image' className="h-auto w-auto max-h-full"  />
                </div>
                <div className="about-section-item md:h-full w-full md:p-10 flex flex-col items-center md:items-start justify-center text-center md:text-left">
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center md:order-2">
                    <Image src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2026%2026%22%3E%3C/svg%3E" data-src={`/assets/images/about/event-page-related-events.jpg`} width={650} height={650} alt='about section image'  className="h-auto w-auto max-h-full"  />
                </div>
                <div className="about-section-item md:h-full w-full md:p-10 flex flex-col items-center md:items-end justify-center text-center md:text-left ">
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center ">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center">
                    <Image src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2026%2026%22%3E%3C/svg%3E" data-src={`/assets/images/about/sign-in-form.jpg`} width={950} height={950} alt='about section image'  className="h-auto w-auto max-h-full" />
                </div>
                <div className="about-section-item md:h-full w-full md:p-10 flex flex-col items-center md:items-start justify-center text-center md:text-left">
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center md:order-2">
                    <Image src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2026%2026%22%3E%3C/svg%3E" data-src={`/assets/images/about/stripe-payment-form--v2.jpg`} width={650} height={650} alt='about section image' className="h-auto w-auto max-h-full" />
                </div>
                <div className="about-section-item md:h-full w-full md:p-10 flex flex-col items-center md:items-end justify-center text-center md:text-left ">
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center ">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center">
                    <Image src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2026%2026%22%3E%3C/svg%3E" data-src={`/assets/images/about/profile-my-tickets.jpg`} width={950} height={950} alt='about section image' className="h-auto w-auto max-h-full"  />
                </div>
                <div className="about-section-item md:h-full w-full md:p-10 flex flex-col items-center md:items-start justify-center text-center md:text-left">
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center md:order-2">
                    <Image src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2026%2026%22%3E%3C/svg%3E" data-src={`/assets/images/about/profile-orginized-events.jpg`} width={650} height={650} alt='about section image'  className="h-auto w-auto max-h-full"  />
                </div>
                <div className="about-section-item md:h-full w-full md:p-10 flex flex-col items-center md:items-end justify-center text-center md:text-left ">
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center ">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center">
                    <Image src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2026%2026%22%3E%3C/svg%3E" data-src={`/assets/images/about/new-event-pending-status.jpg`} width={950} height={950} alt='about section image' className="h-auto w-auto max-h-full"  />
                </div>
                <div className="about-section-item md:h-full w-full md:p-10 flex flex-col items-center md:items-start justify-center text-center md:text-left">
        ...
        <section className="flex bg-cover md:h-[50vh] bg-center py-5 md:py-10">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center">
                <div className="about-section-item md:h-full w-full flex flex-col items-center justify-center md:order-2">
                    <Image src="data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2026%2026%22%3E%3C/svg%3E" data-src={`/assets/images/about/event-deletion-example.jpg`} width={650} height={650} alt='about section image'  className="h-auto w-auto max-h-full"  />
                </div>
                <div className="about-section-item md:h-full w-full md:p-10 flex flex-col items-center md:items-end justify-center text-center md:text-left ">
